...
Config.Open = Keys['E'] --Change the Key also in the Translation!

Config.Locale = 'en' --Translation
...
Config.Pos = vector3(1218.7617, -1269.7955, 34.3656) --Position, where the point is.

Config.Jobs = {'police', 'ambulance', 'fire'} --player jobs, who can enter.

function notification(text)
    ESX.ShowNotification(text) --Variant of notification which is used.
end

function helpnotification(text)
    ESX.ShowHelpNotification(text) --Variant of Help notification which is used.
end